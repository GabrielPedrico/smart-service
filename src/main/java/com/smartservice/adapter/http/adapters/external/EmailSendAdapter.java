...
public class EmailSendAdapter implements EmailSendPort {
    ...
    @Override
    public void sendPedidoEmail(Usuario usuario, Pedido pedido,String msgWpp) throws MessagingException{
        ...
        String msg = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "    <strong>Seu pedido foi registrado!\nPEDIDO:#"+pedido.getCodigoPedido()+"</strong>\n" +
                "  </h1>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 180%;\">STATUS #:AGUARDE CONFIRMAÇÃO</p>\n" +
                "<p style=\"font-size: 14px; line-height: 180%;\">Data: "+pedido.getDataCriacaoPedido().format(DateTimeFormatter.ofPattern("d/M/y"))+"</p>\n" +
                "<p style=\"font-size: 14px; line-height: 180%;\">Horario do pedido:"+pedido.getDataCriacaoPedido().format(DateTimeFormatter.ofPattern("h:m"))+"</p>\n" +
                "<p style=\"font-size: 14px; line-height: 180%;\">Taxa de entrega: "+"+ R$5,00"+"</p>\n" +
                "<p style=\"font-size: 14px; line-height: 180%;\"><span style=\"font-size: 18px; line-height: 32.4px; color: #94f3f7;\">Pedido total $"+valorTotal+"</span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "        \n" +
                "  <h4 class=\"v-text-align\" style=\"margin: 0px; color: #ffffff; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Open Sans',sans-serif; font-size: 18px;\">\n" +
                "    <strong>ENDEREÇO P/ ENTREGA:</strong>\n" +
                "  </h4>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 170%;\">"+usuario.getLogradouro()+", "+usuario.getNumero()+", "+usuario.getCidade()+", "+usuario.getEstado()+"</p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "  <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:arial,helvetica,sans-serif;\"><tr><td class=\"v-text-align\" style=\"font-family:arial,helvetica,sans-serif;\" align=\"center\"><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\""+msgWpp+"\" style=\"height:83px; v-text-anchor:middle; width:580px;\" arcsize=\"5%\" stroke=\"f\" fillcolor=\"#3ae083\"><w:anchorlock/><center style=\"color:#FFFFFF;font-family:arial,helvetica,sans-serif;\"><![endif]-->\n" +
                "    <a href=\""+msgWpp+"\" target=\"_blank\" style=\"box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #3ae083; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;\">\n" +
                "      <span style=\"display:block;padding:20px;line-height:120%;\"><span style=\"font-family: 'comic sans ms', sans-serif; font-size: 18px; line-height: 21.6px;\">Caso seu pedido n&atilde;o tenha gerado um link para finalizar seu atendimento por whatsapp clique aqui.</span></span>\n" +
                "    </a>\n" +
                "  <!--[if mso]></center></v:roundrect></td></tr></table><![endif]-->\n" +
                "</div>\n" +
                "\n" +
                ...
                "\n" +
                "</html>";
        sendEmail(usuario.getEmail(),"SMART SERVICE - PEDIDO",msg);
    }
